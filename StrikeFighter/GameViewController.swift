...
class GameViewController: UIViewController, GameProtocol {
    ...
    func getPlayerTitle() -> Int {
        ...
        setCareerScore(inc: careerScore + temp)
        var temp2 = 0
        if temp < 20 {
            temp2 = 0
...
//            monkeyTitle = scene.childNode(withName: "monkeyTitle") as! SKLabelNode
...
//                setCareerTitle(inc: tempTitle)
//            }
//            monkeyTitle.text = "Rank: \(playerTitle)"
//            var gameDistanceLabel: SKLabelNode!
//            gameDistanceLabel = scene.childNode(withName: "gameDistance") as! SKLabelNode
...
//                setCareerLongDis(inc: calculateDis)
//            }
//            
//            
//            
...
//    }
    ...
    func setCareerScore(inc: Int) {
        UserDefaults.standard.set(inc, forKey: highScoreKey)
    }
    
    func getCareerTitle() -> Int {
        
        let title = UserDefaults.standard.integer(forKey: highTitleKey)
        return title
    }
    func setCareerTitle(inc: Int) {
        UserDefaults.standard.set(inc, forKey: highTitleKey)
    }
    ...
    func getCareerLongDis() -> Int {
        let longDis = UserDefaults.standard.integer(forKey: longDistanceKey)
        return longDis
    }
    
    func setCareerLongDis(inc: Int){
        UserDefaults.standard.set(inc, forKey: longDistanceKey)
    }
